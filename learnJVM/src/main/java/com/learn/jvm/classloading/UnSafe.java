...
/**
 * @author: ZhouJie
 * @date: Create in 2018-09-29 14:28
 * @description:
 * @modified By:
 */
...
public class UnSafe {
     ...
     * <code>volatileField</code>, and is thus expected to change unexpectedly.
     * 设置obj对象中offset偏移地址对应的整型field的值为指定值。这是一个有序或者
     * 有延迟的<code>putIntVolatile</cdoe>方法，并且不保证值的改变被其他线程立
     * 即看到。只有在field被<code>volatileField</code>修饰并且期望被意外修改的时候
     * 使用才有用。
     *
     * @param obj the object containing the field to modify.
     *    包含需要修改field的对象
    ...
    /***
     * Sets the value of the integer field at the specified offset in the
     * supplied object to the given value, with volatileField store semantics.
     ...
     * supplied object with volatileField load semantics.
